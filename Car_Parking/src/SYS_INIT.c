...
void EXTI_INIT(void)
{
	...
	MNVIC_SetIntterruptPriority(37,2,0);    //UART1
	MNVIC_SetIntterruptPriority(38,1,0);    // UART2
	MNVIC_SetIntterruptPriority(MEXTI0, 3, 0);  //EXTI0
	MNVIC_SetIntterruptPriority(MEXTI1, 4, 0); // EXTI1
